...
public class RegisterTransportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText number = (EditText) findViewById(R.id.edit_text_number_pkgs);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pack.add("packages_owners", Arrays.asList(""));
                ...
                pack.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if (e == null) {
                            Toast.makeText(getApplicationContext(), "Transportul a fost adaugat cu succes!", Toast.LENGTH_SHORT).show();
                            finish();
                        }
                        else {
                            Toast.makeText(getApplicationContext(), "Eroare la adaugarea transportului!", Toast.LENGTH_SHORT).show();
